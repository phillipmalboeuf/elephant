...
<picture>
  {#if small}
  <source srcSet="{cdn(media.fields.file.url)}?w=400{ar ? `&fit=pad&h=${Math.round(400 * ar)}` : ''}" media="(max-width: 900px)" />
  <source srcSet="{cdn(media.fields.file.url)}?w=600{ar ? `&fit=pad&h=${Math.round(600 * ar)}` : ''}" media="(max-width: 1200px)" />
  <img src="{cdn(media.fields.file.url)}?w=800{ar ? `&fit=pad&h=${Math.round(800 * ar)}` : ''}"
  ...
  {:else}
  <source srcSet="{cdn(media.fields.file.url)}?w=900{ar ? `&fit=pad&h=${Math.round(900 * ar)}` : ''}" media="(max-width: 900px)" />
  <source srcSet="{cdn(media.fields.file.url)}?w=1200{ar ? `&fit=pad&h=${Math.round(1200 * ar)}` : ''}" media="(max-width: 1200px)" />
  <img src="{cdn(media.fields.file.url)}?w=1800{ar ? `&fit=pad&h=${Math.round(1800 * ar)}` : ''}"
...
{:else}
<picture>
  <img src="{cdn(media)}?w=100{ar ? `&fit=pad&h=${Math.round(100 * ar)}` : ''}"
